...
// optional: verify once on startup to log helpful message
transporter.verify().then(() => {
    console.log('UserController transporter ready (using SMTP):', process.env.EMAIL_HOST);
}).catch(err => {
    console.warn('UserController transporter verification failed:', err.message);
});
